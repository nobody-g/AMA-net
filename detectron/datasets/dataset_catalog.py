...
_DATASETS = {
    'CIHP_seg_train': {
        _IM_DIR:
            '/coco/CIHP/instance-level_human_parsing/Training/Images',
        _ANN_FN:
             '/coco/CIHP/annotations/Training_filter.json',

    },
    'CIHP_seg_val': {
        _IM_DIR:
            '/coco/CIHP/instance-level_human_parsing/Validation/Images',
        _ANN_FN:
            '/coco/CIHP/annotations/Validation.json',
    },
    'MHP_seg_train': {
        _IM_DIR:
            '/coco/MHP/LV-MHP-v2/train/images',
        _ANN_FN:
            '/coco/MHP/LV-MHP-v2/annotations/train_filter.json',
    },
    'MHP_seg_val': {
        _IM_DIR:
            '/coco/MHP/LV-MHP-v2/val/images',
        _ANN_FN:
            '/coco/MHP/LV-MHP-v2/annotations/val.json'
    },
    ...
    'dense_posetrack_2017_train': {
        _IM_DIR:
            _DATA_DIR + '/coco/DensePose_PoseTrack_2017/posetrack_data',
        _ANN_FN:
            _DATA_DIR + '/coco/DensePose_PoseTrack_2017/posetrack_data/densepose_only_posetrack_train2017.json',
    },
    'dense_posetrack_2017_val': {
        _IM_DIR:
            _DATA_DIR + '/coco/DensePose_PoseTrack_2017/posetrack_data',
        _ANN_FN:
            _DATA_DIR + '/coco/DensePose_PoseTrack_2017/posetrack_data/densepose_only_posetrack_val2017.json',
    },
    'dense_posetrack_2017_test': {
        _IM_DIR:
            _DATA_DIR + '/coco/DensePose_PoseTrack_2017/posetrack_data',
        _ANN_FN:
            _DATA_DIR + '/coco/DensePose_PoseTrack_2017/posetrack_data/densepose_posetrack_test2017.json',
    },
