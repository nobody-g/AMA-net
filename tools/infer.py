...
def main(args):
    ...
    for i in range(0, len(args.models_to_run), 2):
        ...
        with c2_utils.NamedCudaScope(0):
            cls_boxes_, cls_segms_, cls_keyps_ , cls_personmasks_ , cls_partsegs_ , cls_bodys_= \
        ...
        cls_personmasks = cls_bodys_ if cls_bodys_ is not None else cls_personmasks_
        cls_partsegs = cls_bodys_ if cls_bodys_ is not None else cls_partsegs_
